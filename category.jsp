		...
		<table>
			<tr>
				...
				<c:choose>
					...
					<c:otherwise>
						<td><form:input path="category_id" pattern =".{3,7}" required="true" title="id should contains 3 to 7 characters" /></td>
					</c:otherwise>
				</c:choose>
			<tr>
			<form:input path="category_id"  hidden="true"  />
				...
				<td><form:input path="category_name" required="true" /></td>
			</tr>
			<tr>
				<td><form:label path="category_description">
						<spring:message text="Category Description" />
					</form:label></td>
				<td><form:input path="category_description" required="true" /></td>
			</tr>
			<tr>
		...
		<table class="tg" style="align:center">
			...
			<c:forEach items="${categoryList}" var="category">
				<tr>
					...
					<td><a href="<c:url value='/editcategory/${category.category_id}' />">Edit</a></td>
					<td><a href="<c:url value='/removecategory/${category.category_id}' />">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
